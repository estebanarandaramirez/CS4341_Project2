...
model = Sequential()
nodes = 50
model.add(Dense(nodes, input_dim=pixels, activation='relu'))
...
print("Time to run: %s seconds" % (time.time() - startTime))

with open('Task4Experiment1.csv', 'w', newline='') as writeFile:
